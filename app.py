...
# ---- LOAD ASSETS ----
lottie_coding = load_lottieurl("https://assets10.lottiefiles.com/packages/lf20_tno6cg2w.json")
...
with st.container():
    ...
    st.write("")
    st.markdown("[To-Do List](https://share.streamlit.io/moustafa1321/websitetest2/main/app.py)")
